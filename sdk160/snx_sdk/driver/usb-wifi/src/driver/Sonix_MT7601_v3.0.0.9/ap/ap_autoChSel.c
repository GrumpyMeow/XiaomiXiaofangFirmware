	...
	)
{
	...
	{
		#ifdef CONFIG_MSTARTV_CUS_SUPPORT //for mstar tcl6308 autochannel select function,select ch1 as opchannel.
     if ((channel_idx==1) ||(channel_idx==6) ||(channel_idx==11))
      pChannelInfo->dirtyness[channel_idx] += 0x65;
     else if ((channel_idx==2) ||(channel_idx==5) ||(channel_idx==7)||(channel_idx==10)||(channel_idx==12))
      pChannelInfo->dirtyness[channel_idx] += 0x45;
		#endif
