...
# Support use force GO SoftAP, iwpriv version.
HAS_GO_SOFTAP_SUPPORT=n
# Support QA ATE function
HAS_QA_SUPPORT=y

# support for mstar tv customization
ifeq ($(PLATFORM),MSTARTV)
HAS_MSTARTV_CUS_SUPPORT=y
endif
...
HAS_P2P_GC_OP_CH_FIRST_SUPPORT=y
endif
...
# for Miracast IOT patch with Samsung Galaxy 3 phone
HAS_MIRACAST_IOT_S3=n
...
HAS_WOW_LOW_POWER_SUPPORT=y
#//the usb host always has the power, this is the sequence
...
#################################################
ifeq ($(HAS_MSTARTV_CUS_SUPPORT),y)
HAS_IWSC_SUPPORT=n
HAS_WIDI_SUPPORT=y
HAS_INTEL_L2SD_TOGGLE_SCAN_SUPPORT=n
HAS_WIDI_GEN4_SUPPORT=y
HAS_INTEL_WFD_SUPPORT=y
HAS_WFA_WFD_SUPPORT=y
...
ifeq ($(HAS_P2P_GC_OP_CH_FIRST_SUPPORT),y)
WFLAGS += -DP2P_GC_OP_CH_FIRST
endif
...
ifeq ($(HAS_MIRACAST_IOT_S3),y)
WFLAGS += -DMIRACAST_IOT_S3
endif
...
ifeq ($(HAS_GO_SOFTAP_SUPPORT),y)
WFLAGS += -DGO_SOFTAP_SUPPORT
endif
...
ifeq ($(HAS_WOW_LOW_POWER_SUPPORT),y)
WFLAGS += -DWOW_LOW_POWER_SUPPORT
endif
...
ifeq ($(PLATFORM),MSTARTV)
EXTRA_CFLAGS += $(WFLAGS) -I$(RT28xx_DIR)/include -DCONFIG_MSTARTV_CUS_SUPPORT
export EXTRA_CFLAGS
endif
