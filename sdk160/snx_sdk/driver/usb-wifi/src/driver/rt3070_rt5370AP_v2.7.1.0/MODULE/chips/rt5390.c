	...
	IN PRTMP_ADAPTER 		pAd)
{
	...
	DBGPRINT(RT_DEBUG_ERROR, ("%s: Initialize frequency - EEPROM = %d, RF_R17 = %d\n", 
					__FUNCTION__, (UCHAR)(pAd->RfFreqOffset & 0x7F), (UCHAR)(RFValue & 0x7F)));

	/* Step 2: Compare EEPROM FreqOffset and RF_R17 to deside whether to set frequency */
	if ((UCHAR)(pAd->RfFreqOffset & 0x7F) != (UCHAR)(RFValue & 0x7F))
	{	
