 ...
 *
 * $Id: wl_cfg80211.c 439392 2013-11-26 20:35:23Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
...
#if defined(OEM_ANDROID)     /* net_os_send_hand_message() is only defined for android \
	builds */
...
#if defined(OEM_ANDROID) && !defined(SUPPORT_PM2_ONLY)
	dhd_pub_t *dhd = (dhd_pub_t *)(wl->pub);
#endif /* (OEM_ANDROID) */
	RETURN_EIO_IF_NOT_UP(wl);
	WL_DBG(("Enter\n"));
                             ...
                             struct cfg80211_sched_scan_request *request)
{
	...
	if (ssid_count) {
		if ((ret = dhd_dev_pno_set_for_ssid(dev, ssids_local, request->n_ssids,
