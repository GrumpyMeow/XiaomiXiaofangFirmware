...
#define ED_STAT_CNT 20
	...
	CHAR SingleSkuRatePwrDiff[18];
		...
		BOOLEAN		bGOSoftApEnable; /* use force go to become softap */ 
#endif /* GO_SOFTAP_SUPPORT */
	BOOLEAN STR_Suspend_enable; /* only use for Suspend to resume function*/
};
...
ULONG BssTableSearch_SsidOrBssid(
	IN BSS_TABLE *Tab, 
	IN PUCHAR	 pBssid,
	IN PUCHAR	 pSsid,
	IN UCHAR	 SsidLen,
