	...
	if (pBuf != NULL)
	{
		...
		while(leftLen)
		{
			...
			if(firstSeg){
				...
				if (((pWscMsgHdr->msgSubType & WSC_UPNP_DATA_SUB_INCLUDE_MAC) == WSC_UPNP_DATA_SUB_INCLUDE_MAC) && (pMACAddr != NULL))
				{
...
/*	UCHAR 			Data[256]; */
	...
	templen = AppendWSCTLV(WSC_ID_DEVICE_NAME, pData, (UCHAR *)(&pAd->P2pCfg.DeviceName), pAd->P2pCfg.DeviceNameLen);
	pData += templen;
	Len   += templen;
#endif /* P2P_SUPPORT */
