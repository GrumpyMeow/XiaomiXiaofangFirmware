...
/bin/cp -r -f ../snx_sdk/app/web-admin/* ../snx_sdk/sdcard/rootfs/
/bin/cp -r -f ../snx_sdk/app/galaxy-server/* ../snx_sdk/sdcard/rootfs/
/bin/cp -r -f ../snx_sdk/app/example/usr/* ../snx_sdk/sdcard/rootfs/usr
